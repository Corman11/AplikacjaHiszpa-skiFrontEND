    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.boxWrapper}>
          <p className={styles.label}>Explicar o ejemplificar</p>
          ...
          return (
            <div className={styles.boxAnwserWrapper} key={box.id}>
              <Draggable nodeRef={questionRefs.current[box.id]}>
                <div
                  className={`${correctanswer === true && box.id === 'explicar_y_ejemplificar' ? styles.boxAnswerCorrect : styles.boxAnswer}`}
