    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.boxWrapper}>
          <p className={styles.label}>Introducir una opinion</p>
          ...
          return (
            <div className={styles.boxAnwserWrapper} key={box.id}>
              <Draggable nodeRef={questionRefs.current[box.id]}>
                <div
                  className={`${correctanswer === true && box.id === 'introducir_una_opinion' ? styles.boxAnswerCorrect : styles.boxAnswer}`}
