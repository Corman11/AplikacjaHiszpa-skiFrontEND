    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.boxWrapper}>
          <p className={styles.label}>Introducir un tema</p>
      ...
      <div className={styles.containerAnswerTop}>
          ...
          return (
            <div className={styles.boxAnwserWrapper} key={box.id}>
              <Draggable nodeRef={questionRefs.current[box.id]}>
                <div
                  className={`${correctanswer === true && box.id === 'introducir_un_tema' ? styles.boxAnswerCorrect : styles.boxAnswer}`}
       ...
       {/* QUESTIONS  END*/}
          ...
          <div className={styles.buttonsBottom}>
            ...
            <button onClick={() => navigate("/TaskFrase5")}
          disabled={!result}
