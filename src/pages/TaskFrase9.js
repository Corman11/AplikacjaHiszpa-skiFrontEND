...
function TaskFrase2() {
  ...
  const correctMap = {
  expresar_duda_o_probabilidad: "gady",
    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.boxWrapper}>
          <p className={styles.label}>Expresar duda o probabilidad</p>
      ...
      <div className={styles.containerAnswerTop}>
          ...
          return (
            <div className={styles.boxAnwserWrapper} key={box.id}>
              <Draggable nodeRef={questionRefs.current[box.id]}>
                <div
                  className={`${correctanswer === true && box.id === 'expresar_duda_o_probabilidad' ? styles.boxAnswerCorrect : styles.boxAnswer}`}
       ...
       {/* QUESTIONS  END*/}
          ...
          <div className={styles.buttonsBottom}>
            ...
            <button onClick={() => navigate("/TaskFrase8")}
          disabled={!result}
        ...
        <button onClick={revealCorrectAnswer}>Sprawdź poprawną odpowiedz</button>
          ...
          <button onClick={() => navigate("/TaskFrase10")}
          disabled={!result}
