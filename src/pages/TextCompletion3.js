...
const correctAnsers = [
  {content: `Esta modalidad genera tanto beneficios como inconvenientes, lo que provoca un debate 
   constante. Hay tantas ventajas como desventajas en la enseñanza virtual.`},

  {content:`Además, esta modalidad reduce costes y facilita el aprendizaje desde cualquier
   lugar.`},

  {content:`Además, la falta de interacción personal limita 
el desarrollo social y la motivación.`},

  {content:`En conclusión, la educación virtual ofrece tantas ventajas, 
como riesgos.`}
